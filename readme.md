...
Not to be confused, KTech is not a software development kit (SDK) in the traditional sense of "game engine". KTech is a library; source and header files you include in your game project.
